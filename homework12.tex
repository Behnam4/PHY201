  ...
  \begin{enumerate}
    \item Find the general solution of the equation: $\ddot y-3\dot y+2y=1+2 e^{3t}$ (here the dots indicate derivatives: $\dot y=dy/dt$, $\ddot y=d^2y/dt^2$).
      ...
      \textcolor{hwColor}{
        ...
        \\
        $
          \dfrac{d^2 (e^{\lambda t})}{dt^2}-3\dfrac{d(e^{\lambda x})}{dt}+2(e^{\lambda x})=0 \\
          \\
          \lambda^2 e^{\lambda t}-3\lambda e^{\lambda t}+2e^{\lambda x}=0 \rightarrow e^{\lambda x} \left[\lambda^2-3\lambda+2\right]=0 \\
          \\
